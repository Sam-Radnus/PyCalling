...
import image from "./Preview6.png";
function Landing() {
  ...
  return (
    ...
    <div className="landing" >
        ...
        <button onClick={()=>{ navigate('/Lobby')}} style={{backgroundColor:'white',cursor:'pointer',padding:'15px',marginLeft:'22vw'}}>Join a Room</button>
        </div>
